...
pp = argparse.ArgumentParser(description='Format VOC2012 metadata.')
pp.add_argument('--load-path', type=str, default='.', help='Path to a directory containing a copy of the VOC2012 dataset.')
