...
from .util.fx_features import register_notrace_function
from .util.helpers import build_model_with_cfg, overlay_external_default_cfg
from .util.layers import PatchEmbed, Mlp, DropPath, to_2tuple, trunc_normal_
from .util.layers import _assert
...
def swin_base_patch4_window12_384(pretrained=False, cfg=None, **kwargs):
...
def swin_base_patch4_window7_224(pretrained=False, cfg=None, **kwargs):
...
def swin_large_patch4_window12_384(pretrained=False, cfg=None, **kwargs):
...
def swin_large_patch4_window7_224(pretrained=False, cfg=None, **kwargs):
...
def swin_base_patch4_window12_384_in22k(pretrained=False, cfg=None, **kwargs):
...
def swin_base_patch4_window7_224_in22k(pretrained=False, cfg=None, **kwargs):
...
def swin_large_patch4_window12_384_in22k(pretrained=False, cfg=None, **kwargs):
...
@register_backbone(feat_dim=192)
def swin_large_patch4_window7_224_in22k(pretrained=False, cfg=None, **kwargs):
