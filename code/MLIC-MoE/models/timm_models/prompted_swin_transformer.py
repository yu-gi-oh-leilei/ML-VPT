...
class PromptedSwinTransformer(SwinTransformer):
    def __init__(
        ...
        use_checkpoint=False, cfg=None, **kwargs
    ):
        prompt_config = cfg.MODEL.PROMPT.SwinTF.prompt_config
...
def _create_swin_transformer(variant, pretrained=False, default_cfg=None, cfg=None, **kwargs):
...
def prompted_swin_base_patch4_window7_224_in22k(pretrained=False, cfg=None, **kwargs):
    """ Swin-B @ 224x224, trained ImageNet-22k
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    # model_kwargs['prompt_config'] = cfg.MODEL.PROMPT.SwinTF.prompt_config
    return _create_swin_transformer('swin_base_patch4_window7_224_in22k', pretrained=pretrained, cfg=cfg, **model_kwargs)
