...
model_urls = {
    'tresnet_l': 'https://miil-public-eu.oss-eu-central-1.aliyuncs.com/model-zoo/tresnet/stanford_cars_tresnet-l-v2_96_27.pth',
}
...
def tresnet_lv2(pretrained, cfg=None, **kwargs):
    """Constructs a large TResnet model.
    """
    layers = [3, 4, 23, 3]
    kwargs['in_chans'] = 3
    kwargs['remove_model_jit'] = False
    kwargs['width_factor'] = 1.0
    return _tresnet('tresnet_l', layers, pretrained, **kwargs)